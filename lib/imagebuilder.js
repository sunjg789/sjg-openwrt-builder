...
const ZSTD_HINT = {
  // qemu-utils(qemu-img) 是产出 qcow2/vdi/vmdk 的必要条件，x86 目标没有它会一路做到最后再失败
  apt: 'sudo apt-get update && sudo apt-get install -y zstd xz-utils build-essential libncurses-dev zlib1g-dev gawk git gettext libssl-dev python3 python3-distutils rsync unzip qemu-utils',
